...
class App extends React.Component {
  ...
  getWeather = async (e) => {
    ...
    function appBackground(){
      document.getElementsByClassName("wrap-app").style.background="black";
  };
    ...
    this.setState({
      ...
      celsius_afteraftertomorrow: this.calCelsius(response.list[24].main.temp),
      wind_afteraftertomorrow: this.calWind(response.list[24].wind.speed),
      description_afteraftertomorrow: response.list[24].weather[0].description,
      tomorrow: "Tomorrow: ",
  ...
  render () {
    ...
    temp_celsius_afteraftertomorrow={this.state.celsius_afteraftertomorrow}
    wind_afteraftertomorrow={this.state.wind_afteraftertomorrow}
    description_afteraftertomorrow={this.state.description_afteraftertomorrow}
