        ...
        <div className="forecast-wrapper">
          <div className="d-flex flex-row justify-content-around mt-3">
            <div className="d-flex flex-column forecast">
              <h6 className="py-0 font-weight-bold">{props.tomorrow}</h6>
            ...
            <div className="d-flex flex-column forecast">
              <h6 className="py-0 font-weight-bold">{props.aftertomorrow}</h6>
            ...
            <div className="d-flex flex-column forecast">
              <h6 className="py-0 font-weight-bold">{props.afteraftertomorrow}</h6>
