  ...
  return (
    <div className="container">
      <div className="cards pt-4">
        ...
        <h3 className="py-2 black-background">{props.description}</h3>

        <h6 className="py-0 mt-0 black-background">{props.wind}</h6>

        <h6 className="py-0 black-background">{props.visibility}</h6>
