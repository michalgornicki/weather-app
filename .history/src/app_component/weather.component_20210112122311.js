...
const Weather = (props) => {
    ...
    <div className="cards pt-4">
        ...
        <div className="py-2">{props.temp_celsius_tomorrow}</div>
        <div className="py-0">{props.wind_tomorrow}</div>
        <div className="py-0">{props.description_tomorrow}</div>

        <h6 className="py-2">{props.temp_celsius_aftertomorrow}</h6>
        <h6 className="py-0">{props.wind_aftertomorrow}</h6>
        <h6 className="py-0">{props.description_aftertomorrow}</h6>

        <h6 className="py-2">{props.temp_celsius_afteraftertomorrow}</h6>
