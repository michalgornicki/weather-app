...
class App extends React.Component {
  ...
  getWeather = async (e) => {
    ...
    this.setState({
      ...
      celsius_aftertomorrow: this.calCelsius(response.list[8].main.temp),
      wind_aftertomorrow: this.calWind(response.list[8].wind.speed),
      description_aftertomorrow: response.list[8].weather[0].description,
      celsius_afteraftertomorrow: this.calCelsius(response.list[8].main.temp),
      wind_afteraftertomorrow: this.calWind(response.list[8].wind.speed),
      description_afteraftertomorrow: response.list[8].weather[0].description,
      error: false
    })
